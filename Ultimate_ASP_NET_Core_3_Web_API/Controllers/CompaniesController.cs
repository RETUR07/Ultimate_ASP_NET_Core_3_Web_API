...
using Ultimate_ASP_NET_Core_3_Web_API.ActionFilters;
using Ultimate_ASP_NET_Core_3_Web_API.ModelBinders;

namespace Ultimate_ASP_NET_Core_3_Web_API.Controllers
{
    [Route("api/companies")]
    [ApiController]
